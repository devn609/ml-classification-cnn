...
🏗️ Architecture
The system consists of two main components:Model Training: A CNN architecture built with TensorFlow/Keras, utilizing layers like Conv2D, MaxPooling2D, Dropout, and Dense.Flask API: A lightweight web server that accepts image uploads and returns JSON predictions.
